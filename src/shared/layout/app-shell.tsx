...
/** What the shell needs to know about the signed-in user (kept structural so shared/ never depends on a feature). */
export type ShellUser = { roles: string[]; displayName: string; email: string; hasProfile: boolean };
